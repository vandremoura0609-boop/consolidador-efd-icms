...
<body>
    <main class="container">
        ...
        <h1>Consolidador E200, E210, E220 e 1250</h1>

        <p>
            Selecione uma pasta contendo arquivos TXT da EFD ICMS IPI.
            A solução consolidará filial, competência, ajustes,
            imposto a recolher, saldo credor, ressarcimento declarado e 
            complemento declarado em uma planilha Excel.
        </p>
        ...
        <div class="footer">
            Registros processados: 0000, 1250, E200, E210 e E220 — UF {{ uf_processada }}.
        </div>
    </main>
...
class EfdConsolidado:
    ...
    ressarcimento_declarado: Decimal = ZERO
    complemento_declarado: Decimal = ZERO
    arquivo_origem: str = ""
...
def processar_texto_efd(texto: str, nome_arquivo: str) -> list[EfdConsolidado]:
    ...
    ressarcimento_1250 = ZERO
    complemento_1250 = ZERO
    ...
    for numero_linha, linha_original in enumerate(texto.splitlines(), start=1):
        ...
        if registro == "1250":
            ressarcimento_1250 = parse_valor(campo(partes, 3))
            complemento_1250 = parse_valor(campo(partes, 5))
            continue
    ...
    for reg in registros:
        reg.ressarcimento_declarado = ressarcimento_1250
        reg.complemento_declarado = complemento_1250
    ...
    for registro in registros_ordenados:
        ws.append(
            [
                ...
                registro.ressarcimento_declarado,
                registro.complemento_declarado,
            ]
        )
...
def aplicar_formatacao_excel(ws: Worksheet) -> None:
    ...
    for row in ws.iter_rows(min_row=2):
        ...
        for coluna_monetaria in range(3, 10):
